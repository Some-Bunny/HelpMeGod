...
public class EnemyDatabase : TileDatabase
{
	...
	public override Dictionary<string, string> Entries { get; set; } = new Dictionary<string, string>
	{
		...
		{
			"dr_wolf",
			"ce2d2a0dced0444fb751b262ec6af08a"
		},
		{
			"Robots",
			Manager.paletteDividerGuid
		...
		{
			"bishop",
			"5d045744405d4438b371eb5ed3e2cdb2"
		},
		{
			"boss_template",
		...
		{
			"veteran_bullet_kin_fakery",
			"06a82532447247f9ada1940d079a31a7"
		},
		{
			"unused_muzzle_flare",
			"98e52539e1964749a8bbce0fe6a85d6b"
		},
		{
			"test_dummy",
