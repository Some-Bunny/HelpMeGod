...
namespace Assets.Scripts.Assembly_CSharp
{
    public class TileDescriptionHandler : MonoBehaviour
    {
        ...
        public static List<TileDescription> tileSecriptions = new List<TileDescription>()
        {
            ...
            new TileDescription(){ tileName = "baby_good_shelleton", DisplayName = "Baby Good Shelleton", Description = "[Warning]\n\nCompanion entity, use with caution."},
            new TileDescription(){ tileName = "baby_mimic", DisplayName = "Baby Good Mimic", Description = "[Warning]\n\nCompanion entity, use with caution."},
            new TileDescription(){ tileName = "blank_companion", DisplayName = "Blank Companion", Description = "[Warning]\n\nCompanion entity, use with caution."},
            new TileDescription(){ tileName = "blank_companion_synergy", DisplayName = "Elder Blank Companion", Description = "[Warning]\n\nCompanion entity, use with caution."},
            new TileDescription(){ tileName = "caterpillar", DisplayName = "Caterpillar", Description = "[Warning]\n\nCompanion entity, use with caution."},
            new TileDescription(){ tileName = "chicken", DisplayName = "Chicken", Description = "Chimken."},
            new TileDescription(){ tileName = "dog", DisplayName = "Dog", Description = "[Warning]\n\nCompanion entity, use with caution."},
            new TileDescription(){ tileName = "dragun_egg_slimeguy", DisplayName = "Dragun Egg", Description = "[Warning]\n\nCompanion entity, use with caution."},
            new TileDescription(){ tileName = "friendly_gatling_gull", DisplayName = "Friendly Gatling Gull", Description = "[Warning]\n\nCompanion entity, use with caution."},
            new TileDescription(){ tileName = "hunters_past_dog", DisplayName = "Wolf", Description = "[Warning]\n\nCompanion entity, use with caution."},
            new TileDescription(){ tileName = "payday_shooter_03", DisplayName = "Payday Companion", Description = "[Warning]\n\nCompanion entity, use with caution."},
            new TileDescription(){ tileName = "phoenix", DisplayName = "Phoenix", Description = "[Warning]\n\nCompanion entity, use with caution."},
            new TileDescription(){ tileName = "raccoon", DisplayName = "Raccoon", Description = "[Warning]\n\nCompanion entity, use with caution."},
            new TileDescription(){ tileName = "ser_junkan", DisplayName = "Ser Junkan", Description = "[Warning]\n\nCompanion entity, use with caution."},
            new TileDescription(){ tileName = "snake", DisplayName = "Snake", Description = "Snek."},
            new TileDescription(){ tileName = "super_space_turtle", DisplayName = "Super Space Turtle", Description = "[Warning]\n\nCompanion entity, use with caution."},
            new TileDescription(){ tileName = "super_space_turtle_dummy", DisplayName = "Turtle", Description = "[Warning]\n\nCompanion entity, use with caution."},
            new TileDescription(){ tileName = "super_space_turtle_synergy", DisplayName = "Super Space Turtle Synergy", Description = "[Warning]\n\nCompanion entity, use with caution."},
            new TileDescription(){ tileName = "turkey", DisplayName = "Turkey", Description = "[Warning]\n\nCompanion entity, use with caution."},
            new TileDescription(){ tileName = "unused_muzzle_flare", DisplayName = "Unused Muzzle Flare", Description = "No thoughts, head empty.\nUse with caution."},
            new TileDescription(){ tileName = "pig", DisplayName = "Pig", Description = "[Warning]\n\nCompanion entity, use with caution."},
            new TileDescription(){ tileName = "pig_synergy", DisplayName = "Cannon Pig", Description = "[Warning]\n\nCompanion entity, use with caution."},
            new TileDescription(){ tileName = "bullet_kings_toadie", DisplayName = "Bullet Kings Toadie", Description = "Passive until hit. Can tank any hit until they become aggressive."},
            new TileDescription(){ tileName = "bullet_kings_toadie_revenge", DisplayName = "Enraged Bullet Kings Toadie", Description = "Chases the player until killed."},
